    ...
    <div class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md" style="background: rgb(173, 230, 187); width:30%; margin:auto; margin-top:20px; margin-bottom:20px;" role="alert">
        <div class="flex p-12 ">
          ...
          <div style="margin-left:20px;">
            ...
            <p class="text-sm">Open html in new tab: <x-jet-nav-link href="{{ url('storage/newsletters/' . $cache['folder'] . '/index.html') }}" target="_blank" :active="request()->routeIs('upload')">{{ $cache['folder'] }}
</x-jet-nav-link></p>
          </div>
        </div>
    </div>
